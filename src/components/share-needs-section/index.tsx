      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">
           ...
           Discover passionate, diverse students from across disciplines and geographies 

Unlock high-quality talent.

Post your needs onto our platform.
          </h2>
...
<h2 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mt-16">
  Get matched. Start building smarter – together!
</h2>      </div>
    </section>
  )
}
